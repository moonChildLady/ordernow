...
class SOURCE extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('ChiName, EnglishName', 'required'),
			array('ChiName, EnglishName', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, ChiName, EnglishName, updatetime', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'fOODs' => array(self::HAS_MANY, 'FOOD', 'Source'),
		);
	}
